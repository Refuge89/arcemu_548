...
enum Opcodes
{
	MSG_NULL_ACTION = 0x000, // null opcode
	...
	CMSG_JOIN_CHANNEL = 0xBAD,	
	CMSG_LEAVE_CHANNEL = 0xBAD,	
	SMSG_CHANNEL_NOTIFY = 0xBAD,	
	CMSG_CHANNEL_LIST = 0xBAD,	
	SMSG_CHANNEL_LIST = 0xBAD,	
	CMSG_CHANNEL_PASSWORD = 0xBAD,	
	CMSG_CHANNEL_SET_OWNER = 0xBAD,	
	CMSG_CHANNEL_OWNER = 0xBAD,	
	CMSG_CHANNEL_MODERATOR = 0xBAD,	
	CMSG_CHANNEL_UNMODERATOR = 0xBAD,	
	CMSG_CHANNEL_MUTE = 0xBAD,	
	CMSG_CHANNEL_UNMUTE = 0xBAD,	
	CMSG_CHANNEL_INVITE = 0xBAD,	
	CMSG_CHANNEL_KICK = 0xBAD,	
	CMSG_CHANNEL_BAN = 0xBAD,	
	CMSG_CHANNEL_UNBAN = 0xBAD,	
	CMSG_CHANNEL_ANNOUNCEMENTS = 0xBAD,	
	CMSG_CHANNEL_MODERATE = 0xBAD,	
	SMSG_UPDATE_OBJECT = 0x1792, // 5.4.8 18414
	SMSG_DESTROY_OBJECT = 0x14C2, // 5.4.8 18414
	CMSG_USE_ITEM = 0xBAD,	
	CMSG_OPEN_ITEM = 0xBAD,	
	CMSG_READ_ITEM = 0xBAD,	
	SMSG_READ_ITEM_OK = 0xBAD,	
	SMSG_READ_ITEM_FAILED = 0xBAD,	
	SMSG_ITEM_COOLDOWN = 0xBAD,	/// TODO: implement
	CMSG_GAMEOBJ_USE = 0xBAD,	// 15595               !!!! NOT SURE !!!!
	CMSG_DESTROY_ITEMS = 0xBAD,
	SMSG_GAMEOBJECT_CUSTOM_ANIM = 0xBAD,	
	CMSG_AREATRIGGER = 0xBAD,	
	MSG_MOVE_START_FORWARD = 0xBAD,	
	MSG_MOVE_START_BACKWARD = 0xBAD,	
	MSG_MOVE_STOP = 0xBAD,	
	MSG_MOVE_START_STRAFE_LEFT = 0xBAD,	
	MSG_MOVE_START_STRAFE_RIGHT = 0xBAD,	
	MSG_MOVE_STOP_STRAFE = 0xBAD,	
	MSG_MOVE_JUMP = 0xBAD,	
	MSG_MOVE_START_TURN_LEFT = 0xBAD,	
	MSG_MOVE_START_TURN_RIGHT = 0xBAD,	
	MSG_MOVE_STOP_TURN = 0xBAD,	
	MSG_MOVE_START_PITCH_UP = 0xBAD,	
	MSG_MOVE_START_PITCH_DOWN = 0xBAD,	
	MSG_MOVE_STOP_PITCH = 0xBAD,	
	MSG_MOVE_SET_RUN_MODE = 0xBAD,	
	MSG_MOVE_SET_WALK_MODE = 0xBAD,	
	MSG_MOVE_TOGGLE_LOGGING = 0xBAD,	// not used in client
	MSG_MOVE_TELEPORT = 0xBAD,	/// TODO: investigate
	MSG_MOVE_TELEPORT_CHEAT = 0xBAD,	
	MSG_MOVE_TELEPORT_ACK = 0xBAD,	
	MSG_MOVE_TOGGLE_FALL_LOGGING = 0xBAD,	// not used in client
	MSG_MOVE_FALL_LAND = 0xBAD,	
	MSG_MOVE_START_SWIM = 0xBAD,	
	MSG_MOVE_STOP_SWIM = 0xBAD,	
	...
	SMSG_ACTION_BUTTONS = 0x081A,	// 5.4.8 18414
	SMSG_INITIAL_SPELLS = 0x045A,	// 5.4.8 18414
	...
	SMSG_QUESTUPDATE_FAILED = 0x1061,	
	...
	SMSG_GM_TICKET_STATUS_UPDATE = 0xBAD,	
	...
	SMSG_SPELLSTEALLOG = 0x333,	// same struct as SMSG_SPELLDISPELLOG
	...
	CMSG_GUILD_BANKER_ACTIVATE = 0xBAD,	
	...
	MSG_WOW_CONNECTION = 0x4F57,					// string used for authentication since 4.x

	CMSG_READY_FOR_ACCOUNT_DATA_TIMES = 0x031C,     // 5.4.8 18414
	CMSG_VIOLENCE_LEVEL = 0x0040,					// 5.4.8 18414
	CMSG_LOG_DISCONNECT = 0x446D,					// 5.4.8 18414 (nothing to implement)
	CMSG_LOAD_SCREEN = 0x1DBD,						// 5.4.8 18414
	CMSG_UI_TIME_REQUEST = 0x4605,					// 5.4.8 18414
	SMSG_UI_TIME = 0x4A14,							// 5.4.8 18414
	...
	CMSG_MESSAGECHAT_DND = 0x0000,					// 5.4.8 18414 gone?
	CMSG_MESSAGECHAT_EMOTE = 0x103E,				// 5.4.8 18414
	CMSG_MESSAGECHAT_PARTY = 0x109A,				// 5.4.8 18414
	CMSG_MESSAGECHAT_RAID = 0x2D44,					// 5.4.8 18414
	CMSG_MESSAGECHAT_RAID_WARNING = 0x109A,			// 5.4.8 18414
	CMSG_MESSAGECHAT_BATTLEGROUND = 0x0000,			// 5.4.8 18414 gone?
